...
$inputs = [
    'modalForm' => [ // id формы
        'Имя' => ['lenStr' => [2, 50, false]], // lenStr - название проверочной функции, 2 и 50 - аргументы передаваемые в функцию (мин и макс символов), true - обризать лишний текст (иначе удаляет все содержимое)
...
// ТЕМА ПИСЬМА
$mail_subject = 'Письмо с сайта Rolen (auto.rolen.com.ua)';
